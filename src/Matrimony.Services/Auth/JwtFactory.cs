...
namespace Matrimony.Services.Auth
{
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<Token> GenerateEncodedToken(string id, string userName)
        {
            ...
            var claims = new[]
            {
                 ...
                 new Claim(System.IdentityModel.Tokens.Jwt.JwtRegisteredClaimNames.Iat, ToUnixEpochDate(_jwtOptions.IssuedAt).ToString(), ClaimValueTypes.Integer64),
